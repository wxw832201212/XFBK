...
public class LearningPlanCtrl {
    ...
    @RequestMapping("/getLearningPlanById")
    @ResponseBody
    public Response addOrUpdateLearningPlan(@RequestParam("token")String token, @RequestParam("id") Integer id) {
        return learningPlanService.getLearningPlan(token, id);
    }
}
